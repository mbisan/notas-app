            ...
            1: [
                function (t, e, r) {
                    ...
                    function i(t) {
                        ...
                        return (
                            2 === o
                                ? ((i = (u[t.charCodeAt(e)] << 2) | (u[t.charCodeAt(e + 1)] >> 4)), (s[f++] = 255 & i))
                                : 1 === o &&
                                  ((i =
                                      (u[t.charCodeAt(e)] << 10) |
                    ...
                    function a(t) {
                        for (var e, r = t.length, n = r % 3, i = "", o = [], a = 16383, u = 0, h = r - n; h > u; u += a)
                            o.push(s(t, u, u + a > h ? h : u + a));
                        return (
                            1 === n
                                ? ((e = t[r - 1]), (i += f[e >> 2]), (i += f[(e << 4) & 63]), (i += "=="))
                                : 2 === n &&
                                  ((e = (t[r - 2] << 8) + t[r - 1]),
                                  (i += f[e >> 10]),
                                  (i += f[(e >> 4) & 63]),
            ...
            3: [
                function (t, e, r) {
                    (function (e) {
                        ...
                        function h(t, e) {
                            if ((f(e), (t = o(t, 0 > e ? 0 : 0 | g(e))), !s.TYPED_ARRAY_SUPPORT))
                        ...
                        function p(t, e, r, n) {
                            ...
                            return (
                                (e = void 0 === n ? new Uint8Array(e, r) : new Uint8Array(e, r, n)),
                                s.TYPED_ARRAY_SUPPORT ? ((t = e), (t.__proto__ = s.prototype)) : (t = c(t, e)),
                                t
                            );
                        }
                        function d(t, e) {
                            ...
                            if (e) {
                                if (
                                    ...
                                    return "number" != typeof e.length || V(e.length) ? o(t, 0) : c(t, e);
                        ...
                        function E(t, e, r, n) {
                            ...
                            for (var f = -1, u = 0; s > r + u; u++)
                                if (i(t, r + u) === i(e, -1 === f ? 0 : u - f)) {
                                    if ((-1 === f && (f = u), u - f + 1 === a)) return (r + f) * o;
                                } else -1 !== f && (u -= u - f), (f = -1);
                            return -1;
                        }
                        function b(t, e, r, n) {
                        ...
                        function k(t, e, r, n, i) {
                            return (
                                i || F(t, e, r, 4, 3.4028234663852886e38, -3.4028234663852886e38),
                        ...
                        function N(t, e, r, n, i) {
                            return (
                                i || F(t, e, r, 8, 1.7976931348623157e308, -1.7976931348623157e308),
                        ...
                        var i = function (t, e, r, i) {
                            if (
                                ...
                                if (
                                    ...
                                    e ||
                                        (e = this._readFile(
                                            chrome.extension.getURL("lib/typo/dictionaries/" + t + "/" + t + ".aff")
                                        )),
                                        r ||
                                            (r = this._readFile(
                                                chrome.extension.getURL("lib/typo/dictionaries/" + t + "/" + t + ".dic")
                                            ));
                                else {
                                ...
                                for (var s = 0, a = this.compoundRules.length; a > s; s++)
                                    for (var f = this.compoundRules[s], u = 0, h = f.length; h > u; u++)
                                ...
                                for (var s in this.compoundRuleCodes)
                                    0 == this.compoundRuleCodes[s].length && delete this.compoundRuleCodes[s];
                                for (var s = 0, a = this.compoundRules.length; a > s; s++) {
                                    for (var l = this.compoundRules[s], c = "", u = 0, h = l.length; h > u; u++) {
                                        var p = l[u];
                                        c +=
                        ...
                        (i.prototype = {
                            ...
                            _readFile: function (e, n) {
                                if ((n || (n = "utf8"), "undefined" != typeof XMLHttpRequest)) {
                                    ...
                                    return (
                                        i.open("GET", e, !1),
                                        i.overrideMimeType && i.overrideMimeType("text/plain; charset=" + n),
                                        i.send(null),
                                        i.responseText
                                    );
                                }
                                    ...
                                    try {
                                        if (o.existsSync(e)) {
                                            var s = o.statSync(e),
                                                a = o.openSync(e, "r"),
                                                f = new r(s.size);
                                            return o.readSync(a, f, 0, f.length, null), f.toString(n, 0, f.length);
                                        }
                                            ...
                                            (E.add = v),
                                                ...
                                                "." !== m &&
                                                    ("SFX" === a
                                                        ...
                                                        : (E.match = new RegExp("^" + m))),
                                                "0" != g &&
                                                    ("SFX" === a ? (E.remove = new RegExp(g + "$")) : (E.remove = g)),
                                                l.push(E);
                                        }
                                        (e[f] = { type: a, combineable: "Y" == u, entries: l }), (n += h);
                                    } else if ("COMPOUNDRULE" === a) {
                                        for (var h = parseInt(s[1], 10), c = n + 1, p = n + 1 + h; p > c; c++) {
                                            var o = r[c],
                                                d = o.split(/\s+/);
                            ...
                            _parseDIC: function (t) {
                                function e(t, e) {
                                    (t in n && "object" == typeof n[t]) || (n[t] = []), n[t].push(e);
                                }
                                ...
                                for (var r = t.split("\n"), n = {}, i = 1, o = r.length; o > i; i++) {
                                    ...
                                    if (a.length > 1) {
                                        ...
                                        ("NEEDAFFIX" in this.flags && -1 != u.indexOf(this.flags.NEEDAFFIX)) || e(f, u);
                                        for (var h = 0, l = u.length; l > h; h++) {
                                            var c = u[h],
                                                p = this.rules[c];
                                            if (p)
                                                for (var d = this._applyRule(f, p), g = 0, y = d.length; y > g; g++) {
                                                    var v = d[g];
                                                    if ((e(v, []), p.combineable))
                                                        for (var w = h + 1; l > w; w++) {
                                                            ...
                                                            if (E && E.combineable && p.type != E.type)
                                                                for (
                                                                    var b = this._applyRule(v, E), R = 0, _ = b.length;
                                                                    _ > R;
                                                                    R++
                                                                ) {
                                                                    var A = b[R];
                                            ...
                                            c in this.compoundRuleCodes && this.compoundRuleCodes[c].push(f);
                                        }
                                    } else e(f.trim(), []);
                                }
                                return n;
                            ...
                            parseRuleCodes: function (t) {
                                ...
                                if ("long" === this.flags.FLAG) {
                                    for (var e = [], r = 0, n = t.length; n > r; r += 2) e.push(t.substr(r, 2));
                                    return e;
                                }
                                return "num" === this.flags.FLAG ? textCode.split(",") : void 0;
                            },
                            _applyRule: function (t, e) {
                                for (var r = e.entries, n = [], i = 0, o = r.length; o > i; i++) {
                                    var s = r[i];
                                    if (!s.match || t.match(s.match)) {
                                        ...
                                        if (
                                            ...
                                            for (var f = 0, u = s.continuationClasses.length; u > f; f++) {
                            ...
                            checkExact: function (t) {
                                ...
                                if ("undefined" == typeof e) {
                                    if ("COMPOUNDMIN" in this.flags && t.length >= this.flags.COMPOUNDMIN)
                            ...
                            hasFlag: function (t, e, r) {
                                if (e in this.flags) {
                                    if ("undefined" == typeof r)
                                        var r = Array.prototype.concat.apply([], this.dictionaryTable[t]);
                            ...
                            suggest: function (t, e) {
                                function r(t) {
                                    for (var e = [], r = 0, n = t.length; n > r; r++) {
                                        for (var i = t[r], o = [], s = 0, a = i.length + 1; a > s; s++)
                                        ...
                                        for (var l = [], s = 0, a = o.length; a > s; s++) {
                                            var h = o[s];
                                            h[1].length > 1 && l.push(h[0] + h[1][1] + h[1][0] + h[1].substring(2));
                                        }
                                        ...
                                        (e = e.concat(f)), (e = e.concat(l)), (e = e.concat(c)), (e = e.concat(g));
                                    }
                                    return e;
                                }
                                function n(t) {
                                    for (var e = [], r = 0; r < t.length; r++) u.check(t[r]) && e.push(t[r]);
                                    return e;
                                }
                                function i(t) {
                                    function i(t, e) {
                                    ...
                                    for (
                                        var o = r([t]), s = r(o), a = n(o).concat(n(s)), f = {}, h = 0, l = a.length;
                                        l > h;
                                        h++
                                    )
                        ...
                        return (
                            ...
                            "function" != typeof t.codeMirrorInstance.defineMode
                                ...
                                : (String.prototype.includes ||
                                  ...
                                  void t.codeMirrorInstance.defineMode("spell-checker", function (e) {
                                      if (!n.aff_loading) {
                                          n.aff_loading = !0;
                                          ...
                                          r.open(
                                              ...
                                              (r.onload = function () {
                                                  4 === r.readyState &&
                                                      ...
                                                      n.num_loaded++,
                                                      2 == n.num_loaded &&
                                                          (n.typo = new i("es_ES", n.aff_data, n.dic_data, {
                                                              platform: "any",
                                                          })));
                                              }),
                                              r.send(null);
                                      ...
                                      var s = '!"#$%&()*+,-./:;<=>?@[\\]^_`{|}~ ',
                                          a = {
                                              token: function (t) {
                                                  ...
                                                  for (; null != (e = t.peek()) && !s.includes(e); ) (r += e), t.next();
                                                  return n.typo && !n.typo.check(r) ? "spell-error" : null;
                                              },
                                          },
                                          f = t.codeMirrorInstance.getMode(e, e.backdrop || "text/plain");
